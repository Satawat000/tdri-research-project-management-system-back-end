...
app.get('/show_resercher_admin',(req,res)=>{
  const res_id = user_detail_admin;
  db.query("SELECT * FROM resercher WHERE  res_id = ?",res_id, (err,result)=>{
    if(err){
      console.log(err);
    }
...
app.post('/publication/TQR/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 20 || catagory = 30) && publish_date BETWEEN ? AND ? ",
...
app.post('/publication/TQO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 20 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/TRO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 30 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/QRO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 20 || catagory = 30 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/TQ/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 20) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/TR/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 30) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/TO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 10 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/QR/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 20 || catagory = 30) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/QO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 20 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/RO/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE (catagory = 30 || catagory = 40) && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.get('/publication/TDRI_Report',(req,res)=>{
...
app.post('/publication/TDRI_Report/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE catagory = 10 && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/Quaterly_Review/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE catagory = 20 && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/Research/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE catagory = 30 && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/publication/Other/date',(req,res)=>{
  const str_date_search = req.body.str_date_search;
  const end_date_search = req.body.end_date_search;
  db.query("SELECT * FROM publication WHERE catagory = 40 && publish_date BETWEEN ? AND ? ",
  [str_date_search,end_date_search], 
  (err,result)=>{
    if(err){
      console.log(err);
...
app.get('/show_member_list',(req,res)=>{
  db.query("SELECT * FROM member_list ; ", (err,result)=>{
    if(err){
      console.log(err);
    }
    else{
...
app.get('/show_keyword_list',(req,res)=>{
  db.query("SELECT * FROM keyword_list ; ", (err,result)=>{
    if(err){
      console.log(err);
    }
    else{
...
app.post('/check_project_id',(req,res)=>{
  const th_name = req.body.th_name;
  db.query("SELECT proj_id,th_name FROM `project` WHERE th_name = ? ",
  [th_name],
   (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/check_project_th_name',(req,res)=>{
  const proj_id = req.body.proj_id;
  db.query("SELECT th_name FROM `project` WHERE proj_id = ? ",
  [proj_id],
   (err,result)=>{
    if(err){
      console.log(err);
...
app.post('/admin_edit_user',(req,res)=>{
  user_detail_admin = req.body.admin_user_id;
  res.send("yes");
});
...
app.delete("/delete_keyword/:id", (req, res) => {
  const id = req.params.id;
  db.query("DELETE FROM keyword_list WHERE kw_id = ?", id, (err, result) => {
    if (err) {
      console.log(err);
    } else {
      res.send("yes");
...
app.delete("/delete_member/:id", (req, res) => {
  const id = req.params.id;
  db.query("DELETE FROM member_list WHERE ml_id = ?", id, (err, result) => {
    if (err) {
      console.log(err);
    } else {
      res.send("yes");
...
//----------------------------------------edit keyword --------------------------
app.get("/edit_keyword/:id", (req, res) => {
  const id = req.params.id;
  db.query("SELECT *  FROM keyword_list WHERE kw_id = ?", id, (err, result) => {
    if (err) {
      console.log(err);
    } else {
      res.send(result);
...
app.put("/update_keyword", (req, res) => { 
  const kw_name = req.body.kw_name; 
  const kw_id = req.body.kw_id;
  //const res_id = req.body.res_id;
  db.query(
    "UPDATE keyword_list SET kw_name = ? WHERE kw_id = ?",
    [kw_name, kw_id],
    (err, result) => {
      if (err) {
        console.log(err);
...
//----------------------------------------edit member list --------------------------
app.get("/edit_member_list/:id", (req, res) => {
  const id = req.params.id;
  db.query("SELECT *  FROM member_list WHERE ml_id = ?", id, (err, result) => {
    if (err) {
      console.log(err);
    } else {
      res.send(result);
...
app.put("/update_member_list", (req, res) => { 
  const ml_name = req.body.ml_name; 
  const ml_id = req.body.ml_id;
  //const res_id = req.body.res_id;
  db.query(
    "UPDATE member_list SET ml_name = ? WHERE ml_id = ?",
    [ml_name, ml_id],
    (err, result) => {
      if (err) {
        console.log(err);
  ...
  db.query(
    ...
    (err, result) => {
      ...
      if (result.length > 0) {
        ...
        loggedIn_server_admin = false;
        res.send({ message: "ไม่มี username นี้ในระบบ" });
      }
    }
  );
});
...
app.get('/admin_list',(req,res)=>{
  //console.log(user_detail[0].ad_username);
  const id_admin = user_detail[0].ad_username;
  
  db.query("SELECT * FROM admin WHERE ad_username != ? ", id_admin,
  (err,result)=>{
    if(err){
      console.log(err);
    }
